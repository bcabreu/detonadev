...
model: inherit
skills: clean-code, full-output-enforcement, intelligent-routing, parallel-agents, behavioral-modes, plan-writing, brainstorming, architecture, lint-and-validate, powershell-windows, bash-linux
---
