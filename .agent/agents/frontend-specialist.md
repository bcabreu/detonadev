...
model: inherit
skills: clean-code, full-output-enforcement, nextjs-react-expert, web-design-guidelines, tailwind-patterns, frontend-design, design-taste-frontend, high-end-visual-design, industrial-brutalist-ui, minimalist-ui, redesign-existing-projects, stitch-design-taste, lint-and-validate
---
